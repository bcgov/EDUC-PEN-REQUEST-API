...
public class PurgeOldRecordsScheduler {
  ...
  public PurgeOldRecordsScheduler(final PenRequestEventRepository penRequestEventRepository) {
  ...
  public void purgeOldRecords() {
    ...
    this.penRequestEventRepository.deleteByCreateDateBefore(createDateToCompare);
